...
const ShareButton = ({ artwork, text }) => {
  ...
  // outside share option click listener
  const handleOutsideShareContainerClick = (event) => {
    if (
  ...
  useEffect(() => {
    document.addEventListener("mousedown", handleOutsideShareContainerClick);
    return () => {
      document.removeEventListener(
        "mousedown",
        handleOutsideShareContainerClick
      );
    };
  }, []);
  ...
  return (
    ...
    >
      <div
        className="hover_color_effect_t-d-kind-of-blue"
        style={{
          display: "flex",
          justifyContent: "center",
          alignItems: "center",
